...
export const SECTIONS: DocSection[] = [
  ...
  { id: 'lob', num: '13', title: 'Lines of Business' },
  { id: 'integrations', num: '14', title: 'Integrations' },
  { id: 'automation', num: '15', title: 'Background automation' },
  { id: 'roles', num: '16', title: 'Users, roles & permissions' },
  { id: 'plans', num: '17', title: 'Plans, limits & billing' },
  { id: 'data', num: '18', title: 'Your data & privacy' },
  { id: 'rules', num: '19', title: 'Default business rules' },
  { id: 'faq', num: '20', title: 'Frequently asked questions' },
