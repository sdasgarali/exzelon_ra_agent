...
function timeAgo(dateStr: string | null) {
  ...
  // Today: show time instead of "Xh ago"
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] text-gray-400 ml-auto flex-shrink-0" title={formatFullDate(t.latest_message_at)}>{timeAgo(t.latest_message_at)}</span>
                        </div>
